  ...
  export const TxDialog = ({
    ...
    return (
      <Dialog  maxWidth={"xs"} fullWidth open={isOpen}>
        <DialogTitle sx={{color:"white", textTransform:"uppercase", fontWeight: 700}} className="tx-dialog">Transaction Status</DialogTitle>
        <DialogContent className="tx-dialog">
          ...
          >
            {isPending && (
              <Typography sx={{ fontSize: "20px", color:"white", fontWeight: 400 }}>
                Transaction Pending
              </Typography>
            )}
            {isFailed && (
